...
import .Broadcast: BroadcastStyle, Style, AbstractArrayStyle, Broadcasted

BroadcastStyle(::Type{<:Taylor1}) = Style{Taylor1}()
BroadcastStyle(::Style{Taylor1}, ::AbstractArrayStyle{0}) = Style{Taylor1}()
BroadcastStyle(::Style{Taylor1}, ::AbstractArrayStyle{1}) = Style{Taylor1}()
...
@inline function Base.copyto!(dest::Taylor1, bc::Broadcasted)
