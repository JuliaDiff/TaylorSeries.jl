...
julia> TaylorN( [HomogeneousPolynomial([1,0]), HomogeneousPolynomial([1,2,3])], 4)
 1⋅x_{1} + 1⋅x_{1}^2 + 2⋅x_{1}⋅x_{2} + 3⋅x_{2}^2
...
julia> 1/(1-xT0)
 1.0 + 1.0⋅t + 1.0⋅t^2 + 1.0⋅t^3 + 1.0⋅t^4 + 1.0⋅t^5
...
julia> (1-xT0)^3.2
 1.0 - 3.2⋅t + 3.5200000000000005⋅t^2 - 1.4080000000000004⋅t^3 + 0.07040000000000009⋅t^4 + 0.011264000000000012⋅t^5

julia> (1+xT0)^xT0
 1.0 + 1.0⋅t^2 - 0.5⋅t^3 + 0.8333333333333333⋅t^4 - 0.75⋅t^5

julia> xTN(1)-yTN(1) # 1+x-(1+y)
 1⋅x_{1} - 1⋅x_{2}

julia> xTN(1)*yTN(1)  # (1+x)*(1+y)
 1 + 1⋅x_{1} + 1⋅x_{2} + 1⋅x_{1}⋅x_{2}

julia> 1/xTN(1)
 1.0 - 1.0⋅x_{1} + 1.0⋅x_{1}^2 - 1.0⋅x_{1}^3 + 1.0⋅x_{1}^4 - 1.0⋅x_{1}^5 + 1.0⋅x_{1}^6
...
```julia
julia> exp(xT0)
 1.0 + 1.0⋅t + 0.5⋅t^2 + 0.16666666666666666⋅t^3 + 0.041666666666666664⋅t^4 + 0.008333333333333333⋅t^5

julia> convert(Taylor1{Rational{Int64}}, ans)
 1//1 + 1//1⋅t + 1//2⋅t^2 + 1//6⋅t^3 + 1//24⋅t^4 + 1//120⋅t^5

julia> log(1-xT0)
 - 1.0⋅t - 0.5⋅t^2 - 0.3333333333333333⋅t^3 - 0.25⋅t^4 - 0.2⋅t^5
...
julia> sqrt( xT(1.0) )   # identic to sqrt( 1+x0 )
 1.0 + 0.5⋅t - 0.125⋅t^2 + 0.0625⋅t^3 - 0.0390625⋅t^4 + 0.02734375⋅t^5

julia> imag(exp(xTI)')
 - 1.0⋅t + 0.16666666666666666⋅t^3 - 0.008333333333333333⋅t^5

julia> real(exp(Taylor1([0.0,1im],17))) - cos(Taylor1([0.0,1.0],17)) == 0.0
true

julia> exp(xTN(0.0)+yTN(0.0))
 1.0 + 1.0⋅x_{1} + 1.0⋅x_{2} + 0.5⋅x_{1}^2 + 1.0⋅x_{1}⋅x_{2} + 0.5⋅x_{2}^2 + 0.16666666666666666⋅x_{1}^3 + 0.5⋅x_{1}^2⋅x_{2} + 0.5⋅x_{1}⋅x_{2}^2 + 0.16666666666666666⋅x_{2}^3 + 0.041666666666666664⋅x_{1}^4 + 0.16666666666666666⋅x_{1}^3⋅x_{2} + 0.25⋅x_{1}^2⋅x_{2}^2 + 0.16666666666666666⋅x_{1}⋅x_{2}^3 + 0.041666666666666664⋅x_{2}^4 + 0.008333333333333333⋅x_{1}^5 + 0.041666666666666664⋅x_{1}^4⋅x_{2} + 0.08333333333333333⋅x_{1}^3⋅x_{2}^2 + 0.08333333333333333⋅x_{1}^2⋅x_{2}^3 + 0.041666666666666664⋅x_{1}⋅x_{2}^4 + 0.008333333333333333⋅x_{2}^5 + 0.0013888888888888887⋅x_{1}^6 + 0.008333333333333331⋅x_{1}^5⋅x_{2} + 0.020833333333333332⋅x_{1}^4⋅x_{2}^2 + 0.027777777777777776⋅x_{1}^3⋅x_{2}^3 + 0.020833333333333332⋅x_{1}^2⋅x_{2}^4 + 0.008333333333333331⋅x_{1}⋅x_{2}^5 + 0.0013888888888888887⋅x_{2}^6

julia> exp(xTN(0.0)+yTN(0.0)) - exp(xTN(0.0))*exp(yTN(0.0))  # should yield 0
 - 1.734723475976807e-18⋅x_{1}^5⋅x_{2} - 1.734723475976807e-18⋅x_{1}⋅x_{2}^5
...
julia> diffTaylor(exp(xT0))
 1.0 + 1.0⋅t + 0.5⋅t^2 + 0.16666666666666666⋅t^3 + 0.041666666666666664⋅t^4

julia> integTaylor(exp(xT0))
 1.0⋅t + 0.5⋅t^2 + 0.16666666666666666⋅t^3 + 0.041666666666666664⋅t^4 + 0.008333333333333333⋅t^5

julia> integTaylor( ans, 1.0)
 1.0 + 0.5⋅t^2 + 0.16666666666666666⋅t^3 + 0.041666666666666664⋅t^4 + 0.008333333333333333⋅t^5
