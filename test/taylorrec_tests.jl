...
facts("\nTesting conversion and promotion") do
...
# facts("\n Testing an identity (proved by Euler)") do
#     for i=1:4
#         ai = symbol(string("a",i))
#         bi = symbol(string("b",i))
#         @eval ($ai) = taylorRec_variable(Int,$i,4)
#         @eval ($bi) = taylorRec_variable(Int,4+($i),4)
#     end
