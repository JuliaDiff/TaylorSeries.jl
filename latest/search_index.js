...

{
    ...
    "title": "Mixtures",
    "category": "section",
    "text": "As mentioned above, Taylor1{T}, HomogeneousPolynomial{T} and TaylorN{T} are parameterized structures structures such that T<:AbstractSeries, the latter is a subtype of Number. Then, we may actually define Taylor expansions in N+1 variables, where one of the variables (the Taylor1 variable) is somewhat special.x, y = set_variables(\"x y\", order=3)\nt = Taylor1([zero(x), one(x)], 5)   The last line defines a Taylor1{TaylorN{Float64}} variable, which is of order 5 in t and order 3 in x and y. Then, we can evaluate functions involving such polynomials:cos(2.1+x+t)This kind of expansions are of interest when studying the dependence of parameters, for instance in the context of bifurcation theory or when considering the dependence of the solution of a differential equation on the initial conditions, around a given solution. In this case, x and y represent small variations around a given value of the parameters, or around some specific initial condition. Such constructions are exploited in the package TaylorIntegration.jl."
},
...
{
    "location": "api.html#TaylorSeries.HomogeneousPolynomial-Tuple{Type{T<:Number},Int64}",
    "page": "API",
    "title": "TaylorSeries.HomogeneousPolynomial",
    "category": "Method",
...
{
    "location": "api.html#TaylorSeries.TaylorN-Tuple{Type{T<:Number},Int64}",
    "page": "API",
    "title": "TaylorSeries.TaylorN",
    "category": "Method",
